...
export default function RoboRacePage() {
  const event = getEventBySlug('ROBORACE')
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-cyan-500/15 rounded-full blur-[150px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-blue-500/15 rounded-full blur-[150px]" />
      </div>
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8 mt-12">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute top-6 left-6 px-4 py-2 bg-green-500/90 backdrop-blur-sm rounded-full border border-green-400/50 animate-pulse">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-gray-900 via-gray-900/80 to-transparent">
              <div className="flex items-center gap-6">
                ...
                <div className="text-right">
                  <p className="text-sm text-gray-300 mb-1">Registration Fee</p>
                  <span className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-xl text-white font-bold text-2xl border border-white/20">
                    ₹{event.price}
                  </span>
                </div>
              </div>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300">Team Size: 2-4 members</span>
            </div>
          </motion.div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="relative">
                <div className="absolute left-[11px] top-3 bottom-3 w-0.5 bg-gradient-to-b from-cyan-500 via-blue-500 to-cyan-500" />
                <div className="space-y-4">
                  {event.schedule.map((item, i) => (
                    <div key={i} className="flex items-center gap-6 pl-8 relative">
                      ...
                      <span className="text-base font-mono font-semibold text-cyan-400 w-28">{item.time}</span>
