...
export default function RoboSoccerPage() {
  const event = getEventBySlug('ROBOSOCCER')
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-green-500/15 rounded-full blur-[150px]" />
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="relative">
                <div className="absolute left-[11px] top-3 bottom-3 w-0.5 bg-gradient-to-b from-green-500 via-emerald-500 to-green-500" />
                <div className="space-y-4">
                  {event.schedule.map((item, i) => (
                    <div key={i} className="flex items-center gap-6 pl-8 relative">
                      ...
                      <span className="text-base font-mono font-semibold text-green-400 w-28">{item.time}</span>
